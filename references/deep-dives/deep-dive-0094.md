...
|---------|----------|-----------|-------------|
| Throughput | 8k RPS | 44k RPS | В 15x лучше |
| Latency p50 | 70ms | 27ms | Улучшение |
| Latency p99 | 482ms | 32ms | Значительное улучшение |
| Error Rate | <0.1% | 0.003% | В пределах нормы |
