...
4. **Четвёртый принцип**: Эффективная отладка production-инцидентов требует системного подхода. Необходимо
...
|---------|----------|-----------|-------------|
| Throughput | 9k RPS | 70k RPS | В 17x лучше |
| Latency p50 | 47ms | 47ms | Улучшение |
| Latency p99 | 485ms | 83ms | Значительное улучшение |
| Error Rate | <0.1% | 0.047% | В пределах нормы |
