...
1. **Первый принцип**: Микросервисы — это не цель, а средство. Переход к микросервисам должен быть обос
...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 94k RPS | В 14x лучше |
| Latency p50 | 43ms | 40ms | Улучшение |
| Latency p99 | 434ms | 73ms | Значительное улучшение |
| Error Rate | <0.1% | 0.090% | В пределах нормы |
