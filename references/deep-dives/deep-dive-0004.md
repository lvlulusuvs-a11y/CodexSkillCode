...
4. **Четвёртый принцип**: Безопасность supply chain — растущая угроза. Software Bill of Materials, signatu
...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 98k RPS | В 16x лучше |
| Latency p50 | 97ms | 27ms | Улучшение |
| Latency p99 | 445ms | 32ms | Значительное улучшение |
| Error Rate | <0.1% | 0.007% | В пределах нормы |
