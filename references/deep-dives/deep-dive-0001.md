...
1. **Первый принцип**: API design — это контракт на годы. Хороший API интуитивно понятен, консистентен 
...
|---------|----------|-----------|-------------|
| Throughput | 10k RPS | 52k RPS | В 10x лучше |
| Latency p50 | 47ms | 40ms | Улучшение |
| Latency p99 | 340ms | 47ms | Значительное улучшение |
