...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 35k RPS | В 19x лучше |
| Latency p50 | 87ms | 39ms | Улучшение |
| Latency p99 | 184ms | 56ms | Значительное улучшение |
| Error Rate | <0.1% | 0.035% | В пределах нормы |
