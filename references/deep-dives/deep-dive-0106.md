...
3. **Третий принцип**: При проектировании распределённых систем ключевым навыком является умение работа
...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 30k RPS | В 15x лучше |
| Latency p50 | 71ms | 44ms | Улучшение |
| Latency p99 | 324ms | 63ms | Значительное улучшение |
