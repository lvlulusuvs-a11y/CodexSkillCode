...
|---------|----------|-----------|-------------|
| Throughput | 9k RPS | 21k RPS | В 17x лучше |
| Latency p50 | 38ms | 14ms | Улучшение |
| Latency p99 | 104ms | 46ms | Значительное улучшение |
| Error Rate | <0.1% | 0.093% | В пределах нормы |
