...
4. **Четвёртый принцип**: Надёжность системы определяется не средним временем безотказной работы, а средни
...
|---------|----------|-----------|-------------|
| Throughput | 7k RPS | 63k RPS | В 14x лучше |
| Latency p50 | 71ms | 3ms | Улучшение |
| Latency p99 | 175ms | 93ms | Значительное улучшение |
