...
|---------|----------|-----------|-------------|
| Throughput | 6k RPS | 72k RPS | В 14x лучше |
| Latency p50 | 60ms | 24ms | Улучшение |
| Latency p99 | 485ms | 41ms | Значительное улучшение |
| Error Rate | <0.1% | 0.088% | В пределах нормы |
