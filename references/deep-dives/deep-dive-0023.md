...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 94k RPS | В 14x лучше |
| Latency p50 | 29ms | 28ms | Улучшение |
| Latency p99 | 474ms | 71ms | Значительное улучшение |
| Error Rate | <0.1% | 0.021% | В пределах нормы |
