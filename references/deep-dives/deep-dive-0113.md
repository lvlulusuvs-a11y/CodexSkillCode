...
3. **Третий принцип**: Observability — это не про инструменты, а про культуру. Хорошая observability по
...
|---------|----------|-----------|-------------|
| Throughput | 8k RPS | 89k RPS | В 15x лучше |
| Latency p50 | 51ms | 18ms | Улучшение |
| Latency p99 | 181ms | 36ms | Значительное улучшение |
| Error Rate | <0.1% | 0.039% | В пределах нормы |
