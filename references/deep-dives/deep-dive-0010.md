...
2. **Второй принцип**: API design — это контракт на годы. Хороший API интуитивно понятен, консистентен 
...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 32k RPS | В 9x лучше |
| Latency p50 | 34ms | 9ms | Улучшение |
| Latency p99 | 233ms | 47ms | Значительное улучшение |
| Error Rate | <0.1% | 0.034% | В пределах нормы |
