# Сети: от Ethernet до InfiniBand
...
1. **Первый принцип**: Производительность начинается с измеримости. Невозможно оптимизировать то, что н
2. **Второй принцип**: Event-driven архитектура мощна, но сложна. Идемпотентность обработчиков, exactly
3. **Третий принцип**: В контексте современных высоконагруженных систем критически важно понимать внутр
...
|---------|----------|-----------|-------------|
| Throughput | 3k RPS | 63k RPS | В 18x лучше |
| Latency p50 | 85ms | 23ms | Улучшение |
| Latency p99 | 367ms | 89ms | Значительное улучшение |
