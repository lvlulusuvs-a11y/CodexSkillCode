# Кеширование: от локального до CDN
...
2. **Второй принцип**: Архитектурная эволюция — естественный процесс. Не существует идеальной архитекту
3. **Третий принцип**: Архитектурная эволюция — естественный процесс. Не существует идеальной архитекту
4. **Четвёртый принцип**: Data-intensive приложения требуют особого подхода к проектированию. Паттерны обр
...
|---------|----------|-----------|-------------|
| Throughput | 3k RPS | 84k RPS | В 6x лучше |
| Latency p50 | 59ms | 1ms | Улучшение |
| Latency p99 | 123ms | 29ms | Значительное улучшение |
| Error Rate | <0.1% | 0.084% | В пределах нормы |
