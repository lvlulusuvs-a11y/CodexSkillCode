...
|---------|----------|-----------|-------------|
| Throughput | 7k RPS | 18k RPS | В 13x лучше |
| Latency p50 | 50ms | 27ms | Улучшение |
| Latency p99 | 137ms | 67ms | Значительное улучшение |
| Error Rate | <0.1% | 0.012% | В пределах нормы |
