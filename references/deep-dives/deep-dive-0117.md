...
1. **Первый принцип**: Observability — это не про инструменты, а про культуру. Хорошая observability по
...
|---------|----------|-----------|-------------|
| Throughput | 8k RPS | 40k RPS | В 10x лучше |
| Latency p50 | 57ms | 35ms | Улучшение |
| Latency p99 | 286ms | 89ms | Значительное улучшение |
| Error Rate | <0.1% | 0.048% | В пределах нормы |
