...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 71k RPS | В 14x лучше |
| Latency p50 | 11ms | 17ms | Улучшение |
| Latency p99 | 376ms | 89ms | Значительное улучшение |
| Error Rate | <0.1% | 0.020% | В пределах нормы |
