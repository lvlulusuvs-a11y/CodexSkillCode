...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 97k RPS | В 19x лучше |
| Latency p50 | 47ms | 29ms | Улучшение |
| Latency p99 | 127ms | 98ms | Значительное улучшение |
| Error Rate | <0.1% | 0.085% | В пределах нормы |
