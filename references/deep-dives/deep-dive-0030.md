...
1. **Первый принцип**: При проектировании распределённых систем ключевым навыком является умение работа
2. **Второй принцип**: Управление техническим долгом — одна из ключевых компетенций Principal Engineer.
...
|---------|----------|-----------|-------------|
| Throughput | 10k RPS | 97k RPS | В 6x лучше |
| Latency p50 | 51ms | 1ms | Улучшение |
| Latency p99 | 218ms | 25ms | Значительное улучшение |
| Error Rate | <0.1% | 0.094% | В пределах нормы |
