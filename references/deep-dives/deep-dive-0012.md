# Атомарные операции и memory barriers
...
1. **Первый принцип**: Управление техническим долгом — одна из ключевых компетенций Principal Engineer.
...
|---------|----------|-----------|-------------|
| Throughput | 4k RPS | 68k RPS | В 5x лучше |
| Latency p50 | 77ms | 42ms | Улучшение |
| Latency p99 | 199ms | 49ms | Значительное улучшение |
| Error Rate | <0.1% | 0.091% | В пределах нормы |
