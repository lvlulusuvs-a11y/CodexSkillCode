...
4. **Четвёртый принцип**: Resilience-паттерны должны быть встроены в архитектуру изначально. Circuit break
...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 35k RPS | В 11x лучше |
| Latency p50 | 50ms | 38ms | Улучшение |
| Latency p99 | 199ms | 56ms | Значительное улучшение |
| Error Rate | <0.1% | 0.019% | В пределах нормы |
