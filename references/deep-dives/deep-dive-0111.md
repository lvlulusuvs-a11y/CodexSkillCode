...
|---------|----------|-----------|-------------|
| Throughput | 9k RPS | 55k RPS | В 18x лучше |
| Latency p50 | 47ms | 45ms | Улучшение |
| Latency p99 | 159ms | 30ms | Значительное улучшение |
| Error Rate | <0.1% | 0.013% | В пределах нормы |
