...
3. **Третий принцип**: Микросервисы — это не цель, а средство. Переход к микросервисам должен быть обос
...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 90k RPS | В 13x лучше |
| Latency p50 | 38ms | 23ms | Улучшение |
| Latency p99 | 237ms | 79ms | Значительное улучшение |
