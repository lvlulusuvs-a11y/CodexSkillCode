...
|---------|----------|-----------|-------------|
| Throughput | 4k RPS | 30k RPS | В 15x лучше |
| Latency p50 | 36ms | 20ms | Улучшение |
| Latency p99 | 330ms | 54ms | Значительное улучшение |
| Error Rate | <0.1% | 0.054% | В пределах нормы |
