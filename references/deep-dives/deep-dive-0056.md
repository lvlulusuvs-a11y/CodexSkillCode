...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 58k RPS | В 17x лучше |
| Latency p50 | 25ms | 40ms | Улучшение |
| Latency p99 | 357ms | 37ms | Значительное улучшение |
| Error Rate | <0.1% | 0.074% | В пределах нормы |
