...
|---------|----------|-----------|-------------|
| Throughput | 9k RPS | 34k RPS | В 16x лучше |
| Latency p50 | 28ms | 27ms | Улучшение |
| Latency p99 | 140ms | 39ms | Значительное улучшение |
| Error Rate | <0.1% | 0.075% | В пределах нормы |
