...
2. **Второй принцип**: Опыт показывает, что большинство проблем в production возникают не из-за отсутст
...
|---------|----------|-----------|-------------|
| Throughput | 6k RPS | 78k RPS | В 14x лучше |
| Latency p50 | 82ms | 28ms | Улучшение |
| Latency p99 | 432ms | 89ms | Значительное улучшение |
| Error Rate | <0.1% | 0.010% | В пределах нормы |
