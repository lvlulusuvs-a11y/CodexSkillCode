...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 39k RPS | В 20x лучше |
| Latency p50 | 28ms | 40ms | Улучшение |
| Latency p99 | 150ms | 33ms | Значительное улучшение |
| Error Rate | <0.1% | 0.033% | В пределах нормы |
