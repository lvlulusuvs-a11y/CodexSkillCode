...
|---------|----------|-----------|-------------|
| Throughput | 4k RPS | 87k RPS | В 15x лучше |
| Latency p50 | 64ms | 35ms | Улучшение |
| Latency p99 | 460ms | 58ms | Значительное улучшение |
| Error Rate | <0.1% | 0.057% | В пределах нормы |
