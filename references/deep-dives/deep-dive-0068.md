...
3. **Третий принцип**: Event-driven архитектура мощна, но сложна. Идемпотентность обработчиков, exactly
4. **Четвёртый принцип**: При проектировании распределённых систем ключевым навыком является умение работа
...
|---------|----------|-----------|-------------|
| Throughput | 6k RPS | 39k RPS | В 3x лучше |
| Latency p50 | 39ms | 29ms | Улучшение |
| Latency p99 | 257ms | 32ms | Значительное улучшение |
| Error Rate | <0.1% | 0.040% | В пределах нормы |
