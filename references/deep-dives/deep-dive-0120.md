# Circuit breaker в микросервисах
...
1. **Первый принцип**: В контексте современных высоконагруженных систем критически важно понимать внутр
2. **Второй принцип**: Масштабирование систем — это всегда серия компромиссов. Горизонтальное масштабир
...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 23k RPS | В 10x лучше |
| Latency p50 | 85ms | 39ms | Улучшение |
| Latency p99 | 125ms | 25ms | Значительное улучшение |
| Error Rate | <0.1% | 0.071% | В пределах нормы |
