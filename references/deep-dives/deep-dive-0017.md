...
|---------|----------|-----------|-------------|
| Throughput | 10k RPS | 17k RPS | В 7x лучше |
| Latency p50 | 63ms | 44ms | Улучшение |
| Latency p99 | 486ms | 38ms | Значительное улучшение |
| Error Rate | <0.1% | 0.099% | В пределах нормы |
