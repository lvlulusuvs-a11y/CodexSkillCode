...
|---------|----------|-----------|-------------|
| Throughput | 3k RPS | 42k RPS | В 15x лучше |
| Latency p50 | 38ms | 44ms | Улучшение |
| Latency p99 | 441ms | 76ms | Значительное улучшение |
| Error Rate | <0.1% | 0.082% | В пределах нормы |
