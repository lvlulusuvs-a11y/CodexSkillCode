...
3. **Третий принцип**: Эффективная отладка production-инцидентов требует системного подхода. Необходимо
...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 36k RPS | В 12x лучше |
| Latency p50 | 40ms | 42ms | Улучшение |
| Latency p99 | 104ms | 72ms | Значительное улучшение |
| Error Rate | <0.1% | 0.078% | В пределах нормы |
