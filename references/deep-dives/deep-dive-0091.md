...
|---------|----------|-----------|-------------|
| Throughput | 8k RPS | 93k RPS | В 20x лучше |
| Latency p50 | 99ms | 22ms | Улучшение |
| Latency p99 | 468ms | 51ms | Значительное улучшение |
| Error Rate | <0.1% | 0.089% | В пределах нормы |
