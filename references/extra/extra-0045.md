...
2. **Второй принцип**: Производительность начинается с измеримости. Невозможно оптимизировать то, что н
...
|---------|----------|-----------|-------------|
| Throughput | 6k RPS | 13k RPS | В 11x лучше |
| Latency p50 | 13ms | 25ms | Улучшение |
| Latency p99 | 426ms | 51ms | Значительное улучшение |
| Error Rate | <0.1% | 0.011% | В пределах нормы |
