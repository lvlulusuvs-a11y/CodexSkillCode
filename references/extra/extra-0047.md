...
|---------|----------|-----------|-------------|
| Throughput | 8k RPS | 24k RPS | В 15x лучше |
| Latency p50 | 88ms | 24ms | Улучшение |
| Latency p99 | 263ms | 83ms | Значительное улучшение |
| Error Rate | <0.1% | 0.008% | В пределах нормы |
