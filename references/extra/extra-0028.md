...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 64k RPS | В 12x лучше |
| Latency p50 | 20ms | 27ms | Улучшение |
| Latency p99 | 313ms | 45ms | Значительное улучшение |
| Error Rate | <0.1% | 0.006% | В пределах нормы |
