...
|---------|----------|-----------|-------------|
| Throughput | 3k RPS | 62k RPS | В 17x лучше |
| Latency p50 | 33ms | 19ms | Улучшение |
| Latency p99 | 260ms | 45ms | Значительное улучшение |
| Error Rate | <0.1% | 0.096% | В пределах нормы |
