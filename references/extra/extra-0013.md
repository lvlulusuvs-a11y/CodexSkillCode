...
3. **Третий принцип**: Надёжность системы определяется не средним временем безотказной работы, а средни
4. **Четвёртый принцип**: В контексте современных высоконагруженных систем критически важно понимать внутр
...
|---------|----------|-----------|-------------|
| Throughput | 4k RPS | 55k RPS | В 5x лучше |
| Latency p50 | 100ms | 46ms | Улучшение |
| Latency p99 | 408ms | 20ms | Значительное улучшение |
| Error Rate | <0.1% | 0.002% | В пределах нормы |
