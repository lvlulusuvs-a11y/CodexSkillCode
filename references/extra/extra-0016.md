...
3. **Третий принцип**: Безопасность supply chain — растущая угроза. Software Bill of Materials, signatu
...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 28k RPS | В 10x лучше |
| Latency p50 | 10ms | 17ms | Улучшение |
| Latency p99 | 141ms | 47ms | Значительное улучшение |
