...
|---------|----------|-----------|-------------|
| Throughput | 4k RPS | 40k RPS | В 11x лучше |
| Latency p50 | 93ms | 19ms | Улучшение |
| Latency p99 | 395ms | 95ms | Значительное улучшение |
| Error Rate | <0.1% | 0.063% | В пределах нормы |
