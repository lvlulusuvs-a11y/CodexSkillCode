...
|---------|----------|-----------|-------------|
| Throughput | 10k RPS | 99k RPS | В 7x лучше |
| Latency p50 | 73ms | 45ms | Улучшение |
| Latency p99 | 207ms | 94ms | Значительное улучшение |
| Error Rate | <0.1% | 0.045% | В пределах нормы |
