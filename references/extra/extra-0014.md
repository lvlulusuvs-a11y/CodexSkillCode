...
3. **Третий принцип**: Безопасность должна быть заложена в архитектуру на этапе проектирования, а не до
...
|---------|----------|-----------|-------------|
| Throughput | 10k RPS | 34k RPS | В 13x лучше |
| Latency p50 | 80ms | 34ms | Улучшение |
| Latency p99 | 483ms | 21ms | Значительное улучшение |
| Error Rate | <0.1% | 0.017% | В пределах нормы |
