...
|---------|----------|-----------|-------------|
| Throughput | 9k RPS | 60k RPS | В 19x лучше |
| Latency p50 | 73ms | 30ms | Улучшение |
| Latency p99 | 371ms | 73ms | Значительное улучшение |
| Error Rate | <0.1% | 0.087% | В пределах нормы |
