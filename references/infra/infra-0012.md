...
1. **Первый принцип**: Code review — не бюрократическая процедура, а инструмент передачи знаний и повыш
2. **Второй принцип**: Caching — это всегда баланс между свежестью данных и производительностью. Инвали
...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 11k RPS | В 16x лучше |
| Latency p50 | 93ms | 20ms | Улучшение |
| Latency p99 | 413ms | 56ms | Значительное улучшение |
