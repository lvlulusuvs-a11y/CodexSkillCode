...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 45k RPS | В 20x лучше |
| Latency p50 | 48ms | 24ms | Улучшение |
| Latency p99 | 481ms | 49ms | Значительное улучшение |
| Error Rate | <0.1% | 0.043% | В пределах нормы |
