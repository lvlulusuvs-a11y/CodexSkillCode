...
|---------|----------|-----------|-------------|
| Throughput | 10k RPS | 52k RPS | В 5x лучше |
| Latency p50 | 92ms | 17ms | Улучшение |
| Latency p99 | 426ms | 55ms | Значительное улучшение |
| Error Rate | <0.1% | 0.092% | В пределах нормы |
