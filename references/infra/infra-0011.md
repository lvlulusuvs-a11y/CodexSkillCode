...
|---------|----------|-----------|-------------|
| Throughput | 4k RPS | 19k RPS | В 14x лучше |
| Latency p50 | 27ms | 12ms | Улучшение |
| Latency p99 | 212ms | 85ms | Значительное улучшение |
| Error Rate | <0.1% | 0.064% | В пределах нормы |
