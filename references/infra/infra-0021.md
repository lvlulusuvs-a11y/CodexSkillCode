...
4. **Четвёртый принцип**: Масштабирование систем — это всегда серия компромиссов. Горизонтальное масштабир
...
|---------|----------|-----------|-------------|
| Throughput | 2k RPS | 56k RPS | В 11x лучше |
| Latency p50 | 42ms | 15ms | Улучшение |
| Latency p99 | 404ms | 32ms | Значительное улучшение |
