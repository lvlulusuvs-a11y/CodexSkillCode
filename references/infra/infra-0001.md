...
|---------|----------|-----------|-------------|
| Throughput | 1k RPS | 24k RPS | В 13x лучше |
| Latency p50 | 77ms | 18ms | Улучшение |
| Latency p99 | 238ms | 74ms | Значительное улучшение |
| Error Rate | <0.1% | 0.052% | В пределах нормы |
