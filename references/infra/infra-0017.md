...
1. **Первый принцип**: Caching — это всегда баланс между свежестью данных и производительностью. Инвали
...
|---------|----------|-----------|-------------|
| Throughput | 5k RPS | 20k RPS | В 7x лучше |
| Latency p50 | 30ms | 41ms | Улучшение |
| Latency p99 | 174ms | 96ms | Значительное улучшение |
